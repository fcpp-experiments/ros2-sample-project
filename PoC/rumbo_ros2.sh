...
world_file="use_case_resources/maze/maze.sdf"

GAZEBO_MODEL_PATH=$(pwd) \
ROBOTS_YAML=use_case_resources/maze/robots.yaml \
ros2 launch rumbo_gazebo rumbo_ros2_only.launch.py use_proxies:=false \
